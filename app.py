...
st.markdown("Patient: Mrs. Zubaida Khan | Real Medical Data | 52 Visits")

st.sidebar.header("Enter Patient Data")
days = st.sidebar.slider("Days From Surgery", -500, 1000, 100)
iop_left = st.sidebar.slider("IOP Left Eye (mmHg)", 5, 45, 15)
...
cornea_encoded = st.sidebar.selectbox("Cornea Finding (0/1)", [0, 1])
...
if st.button("Predict"):
    ...
    stage_map = {0: "Early Recovery", 1: "Mid Recovery", 2: "Good Recovery", 3: "Pre Surgery"}
