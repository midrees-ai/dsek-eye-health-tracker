...
Mrs. Zubaida Khan (Grandmother) — 52 hospital visits across 3 hospitals.
...
- IOP threshhold: IOP ≥ 21 =high risk, IOP < 21 = normal
...
## Project Structure
- eye_data.csv — Real patient data (52 visits)
